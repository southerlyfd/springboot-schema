          ...
          <el-form-item v-if="ruleForm.xingming" label="姓名" prop="xingming">
              <el-input v-model="ruleForm.xingming" 
                placeholder="姓名" readonly></el-input>
                        ...
                        <el-col :span="12">
        <el-form-item  v-if="type!='info'"  label="书籍名称" prop="shujimingcheng">
          <el-input v-model="ruleForm.shujimingcheng" 
              placeholder="书籍名称" clearable></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.shujimingcheng" label="书籍名称" prop="shujimingcheng">
              <el-input v-model="ruleForm.shujimingcheng" 
                placeholder="书籍名称" readonly></el-input>
                        ...
                        <el-col :span="12">
        <el-form-item  v-if="type!='info'"  label="书籍类别" prop="shujileibie">
          <el-input v-model="ruleForm.shujileibie" 
              placeholder="书籍类别" clearable></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.shujileibie" label="书籍类别" prop="shujileibie">
              <el-input v-model="ruleForm.shujileibie" 
          ...
          <el-form-item v-if="ruleForm.yonghuming" label="用户名" prop="yonghuming">
              <el-input v-model="ruleForm.yonghuming" 
                placeholder="用户名" readonly></el-input>
                        ...
                        <el-col :span="12">
        <el-form-item  v-if="type!='info'"  label="收货地址" prop="shouhuodizhi">
          ...
          <el-form-item v-if="ruleForm.shouhuodizhi" label="收货地址" prop="shouhuodizhi">
              <el-input v-model="ruleForm.shouhuodizhi" 
                placeholder="收货地址" readonly></el-input>
                        ...
                        <el-col :span="12">
        <el-form-item  v-if="type!='info'"  label="收货人" prop="shouhuoren">
          <el-input v-model="ruleForm.shouhuoren" 
              placeholder="收货人" clearable></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.shouhuoren" label="收货人" prop="shouhuoren">
              <el-input v-model="ruleForm.shouhuoren" 
          ...
          <el-form-item v-if="ruleForm.lianxidianhua" label="联系电话" prop="lianxidianhua">
              <el-input v-model="ruleForm.lianxidianhua" 
                placeholder="联系电话" readonly></el-input>
                        ...
                        <el-col :span="12">
        <el-form-item  v-if="type!='info'"  label="订单备注" prop="dingdanbeizhu">
          <el-input v-model="ruleForm.dingdanbeizhu" 
              placeholder="订单备注" clearable></el-input>
        </el-form-item>
        <div v-else>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
            ...
            continue;
                    ...
                    if(o=='shujileibie'){
            this.ruleForm.shujileibie = obj[o];
            continue;
          }
                    if(o=='ershoujiage'){
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                                                ...
                                                                                                // 多级联动参数
                                                                                                                          info(id) {
      this.$http({
        url: `ershoushujidingdan/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `ershoushujidingdan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.ershoushujidingdanCrossAddOrUpdateFlag = false;
                  this.parent.search();
                }
              });
            } else {
